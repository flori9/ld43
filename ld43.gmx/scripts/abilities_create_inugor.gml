...
ds_list_add_map(abilities, ability_create("Pig Surge", "Uses pig magic to do X damage to a target.", ability_choose_target, array(alignment_other, ability_do_fromstaff, ability_pigsurge, "Pig Surge", strategyHighestHP), requirement_set_pigs(requirement_create(), 1, 0), 10));
