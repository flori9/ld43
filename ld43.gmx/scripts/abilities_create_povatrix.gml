...
ds_list_add_map(abilities, ability_create("Pig Bolt", "Does damage equal to the number of pigs you have.", ability_choose_target, array(alignment_other, ability_pay_mana, array(2, ability_do_fromstaff, ability_pigbolt), "Pig Bolt", strategySelf), requirement_set_mana(requirement_create(), 2), 10));
