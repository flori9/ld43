...
ds_list_add_map(abilities, ability_create("Accelerate Poison", "All poison drops do one extra damage instantly.", ability_do_fromstaff_noTarget, ability_acceleratepoison, requirement_create(), 0));
